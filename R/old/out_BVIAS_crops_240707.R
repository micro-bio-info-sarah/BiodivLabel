...
BVLU_from_practices <- function(input,normalized_value,BV_constant,id_cols,print_plot) {
...
for (tested_variable in tmp_effect_size$metric_number) {
  ...
  tmp_q25_BVLU <- BVLU_from_practices(tmp_q25_input,"normalized_value",model_parameters,"id_cols",F)
  ...
  tmp_q75_BVLU <- BVLU_from_practices(tmp_q75_input,"normalized_value",model_parameters,"id_cols",F)
