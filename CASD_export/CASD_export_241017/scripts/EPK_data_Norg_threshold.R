...
write.csv(tmp_EPK_Norg_all,paste0("~/BiodivLabel/data_out/PKGC_N_ferti_org_",Sys.Date(),".csv"),quote = F,row.names = T)
...
write.csv(tmp_EPK_Norg,paste0("~/BiodivLabel/data_out/PKGC_N_ferti_org_threshold_",Sys.Date(),".csv"),quote = F,row.names = T)
