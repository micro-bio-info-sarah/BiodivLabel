...
|-----|-----|--:|
| Low VS maximum use of plant protection products [@beketov_pesticides_2013] | @eq-ES_pesticides ^1^ | 0.35  |
| Few VS maximum nitrogen inputs [@sanchez-bayo_worldwide_2019]  |  @eq-ES_nitrogen | 0.35^2^  |
| High cultural diversity with 3 crop type sampled VS low cultural diversity with 1 crop type sampled [@sirami_increasing_2019]  | @eq-ES_shannon  | 0.18  |
| High VS low density of semi-natural cover [@sirami_increasing_2019] |  @eq-ES_SNC | 0.11  |
| Huge VS small mean field size [@sirami_increasing_2019]  |  @eq-MFS |  -0.05 |
| Organic VS conventional farming [@tuck_land-use_2014]  |  @eq-org_conv ^3^ | +34% (95% CI: 26–43)  |
...
\frac{\frac{BV_{loc,P,ha} (pesticide \space use \space 5^{th} \space percentile, \space other \space variable \space median) + BV_{loc,C,ha} (pesticide \space use \space 5^{th} \space percentile, \space other \space variable \space median)}{2} - BV_{loc,C,ha} (pesticide \space use \space 95^{th} \space percentile, \space other \space variable \space median)}{\frac{BV_{loc,P,ha} (pesticide \space use \space 5^{th} \space percentile, \space other \space variable \space median) + BV_{loc,C,ha} (pesticide \space use \space 5^{th} \space percentile, \space other \space variable \space median)}{2}}

$$ {#eq-ES_pesticides}

$$

\frac{\frac{BV_{loc,P,ha} (nitrogen \space input \space 5^{th} \space percentile, \space other \space variable \space median) + BV_{loc,C,ha} (nitrogen \space input \space 5^{th} \space percentile, \space other \space variable \space median)}{2} - BV_{loc,C,ha} (nitrogen \space input \space 95^{th} \space percentile, \space other \space variable \space median)}{\frac{BV_{loc,P,ha} (nitrogen \space input \space 5^{th} \space percentile, \space other \space variable \space median) + BV_{loc,C,ha} (nitrogen \space input \space 5^{th} \space percentile, \space other \space variable \space median)}{2}}

$$ {#eq-ES_nitrogen}

$$

\frac{ BV_{loc,ha}(Shannon \space index \space 75^{th} \space percentile \space for \space farms \space with \space 3 \space crops, \space other \space variable \space median) - BV_{loc,ha} (Shannon \space index \space 25^{th} \space percentile \space for \space farms \space with \space 1 \space crop, \space other \space variable \space median)}{BV_{loc,ha}(Shannon \space index \space 75^{th} \space percentile \space for \space farms \space with \space 3 \space crops, \space other \space variable \space median)}

$$ {#eq-ES_shannon}

$$

\frac{ BV_{loc,ha}(hedge \space density \space 75^{th} \space percentile, \space other \space variable \space median) - BV_{loc,ha} (hedge \space density \space 25^{th} \space percentile, \space other \space variable \space median)}{BV_{loc,ha}(hedge \space density \space 75^{th} \space percentile, \space other \space variable \space median)}

$$ {#eq-ES_SNC}

$$

\frac{ BV_{loc,ha}(mean \space field \space size \space 75^{th} \space percentile, \space other \space variable \space median) - BV_{loc,ha} (mean \space field \space size \space 25^{th} \space percentile, \space other \space variable \space median)}{BV_{loc,ha}(mean \space field \space size \space 75^{th} \space percentile, \space other \space variable \space median)}

$$ {#eq-ES_MFS}

$$

\frac{ BV_{loc,ha}(organic \space soft \space wheat)}{BV_{loc,ha}(conventional \space soft \space wheat)}
