...
mean(BVIAS_to_RICA_RA_SIQO_milk$BVIAS_ha_feed[
  BVIAS_to_RICA_RA_SIQO_milk$FQS == "AB"])
mean(BVIAS_to_RICA_RA_SIQO_milk$BVIAS_ha_feed[
  BVIAS_to_RICA_RA_SIQO_milk$FQS == "Comte - Morbier"])
mean(BVIAS_to_RICA_RA_SIQO_milk$BVIAS_ha_feed[
  BVIAS_to_RICA_RA_SIQO_milk$FQS == "Beurre de Charentes-Poitou"])

1-(mean(BVIAS_to_RICA_RA_SIQO_milk$BVIAS_ha_feed[BVIAS_to_RICA_RA_SIQO_milk$FQS == "Comte - Morbier"]) / mean(BVIAS_to_RICA_RA_SIQO_milk$BVIAS_ha_feed[BVIAS_to_RICA_RA_SIQO_milk$FQS == "Conventionnel" & BVIAS_to_RICA_RA_SIQO_milk$farm_id %in% matched_data$farm_id[matched_data$match == "Lait__Comte - Morbier"]]))
