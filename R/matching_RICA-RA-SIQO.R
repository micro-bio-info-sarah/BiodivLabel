...
RICA_RA_SIQO_farm <- RICA_RA %>%
  left_join(.,tmp_SIQO_RA_farm)

## join by product

RICA_RA_SIQO_product_n_wine <- RICA_RA %>%
  ...
  left_join(.,RA2020 %>% select(NOM_DOSSIER,BIO_FIL,BIO_INTEGRAL,BIODYNAMIE,NATUREPROGRES,HVE)) %>%
...
RICA_RA_SIQO_product <- RICA_RA_SIQO_product_n_wine %>%
