...
source("R/TEST_SENSI_calibration_w0_Tuck_BVIAS_functions.R")
...
#save(list = "tmp_optim_ls",file = paste0("data_out/TEST_SENSI_calibration_w0_Tuck_optim_",Sys.Date(),".RData"))
load("~/BiodivLabel/data_out/TEST_SENSI_calibration_w0_Tuck_optim_2024-12-19.RData")
...
write.csv(tmp_table,paste0("~/BiodivLabel/data_out/TEST_SENSI_calibration_w0_Tuck_table_MSE_distance_table",Sys.Date(),".csv"))
...
#tmp_plot
svg(paste0("~/BiodivLabel/data_out/TEST_SENSI_calibration_w0_Tuck_plot_BVC_functions_before_optimization_",Sys.Date(),".svg"))
ggsave(filename = paste0("~/BiodivLabel/data_out/TEST_SENSI_calibration_w0_Tuck_plot_BVC_functions_before_optimization_",Sys.Date(),".svg"), plot = tmp_plot,width = 30,height = 20,units = "cm")
...
#tmp_plot
svg(paste0("~/BiodivLabel/data_out/TEST_SENSI_calibration_w0_Tuck_plot_BVC_functions_after_optimization_",Sys.Date(),".svg"))
ggsave(filename = paste0("~/BiodivLabel/data_out/TEST_SENSI_calibration_w0_Tuck_plot_BVC_functions_after_optimization_",Sys.Date(),".svg"), plot = tmp_plot,width = 30,height = 20,units = "cm")
...
write.csv(tmp_table,paste0("~/BiodivLabel/data_out/TEST_SENSI_calibration_w0_Tuck_table_ES_table",Sys.Date(),".csv"))
...
tmp_plot <- ggplot(tmp_table) +
  ...
  facet_wrap(vars(set))
#tmp_plot
svg(paste0("~/BiodivLabel/data_out/TEST_SENSI_calibration_w0_Tuck_plot_effect_size",Sys.Date(),".svg"))
ggsave(filename = paste0("~/BiodivLabel/data_out/TEST_SENSI_calibration_w0_Tuck_plot_effect_size",Sys.Date(),".svg"), plot = tmp_plot,width = 30,height = 20,units = "cm")
...
TEST_SENSI_calibration_w0_Tuck_BVIAS_to_RICA_crops <- tmp_BVIAS_optim$BVIAS %>%
...
TEST_SENSI_calibration_w0_Tuck_optim_final <- list(
