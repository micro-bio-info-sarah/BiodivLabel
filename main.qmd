...
BV_A.2.1 <- BV_A.4.5 %>%
  select(farm_id,crop) %>%
  mutate(
    A.2.1 = rnorm(nrow(BV_A.4.5),mean = 0.05,sd = 0.001)
  )
...
BV_A.2.2 <- BV_A.4.5 %>%
  select(farm_id,crop) %>%
  mutate(
    A.2.2 = rnorm(nrow(BV_A.4.5),mean = 0.05,sd = 0.001)
  )
...
BV_A.3.2 <- BV_A.4.5 %>%
  select(farm_id,crop) %>%
  mutate(
    A.3.2 = rnorm(nrow(BV_A.4.5),mean = 0.05,sd = 0.001)
  )
...
BV_A.3.3 <- BV_A.4.5 %>%
  select(farm_id,crop) %>%
  mutate(
    A.3.3 = rnorm(nrow(BV_A.4.5),mean = 0.05,sd = 0.001)
  )
